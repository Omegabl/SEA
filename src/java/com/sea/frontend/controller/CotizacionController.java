...
//2nd paso)compose message
				try {
					...
					adjunto.setDataHandler(new DataHandler(new FileDataSource("C:\\Users\\Administrator\\Documents\\NetBeansProjects\\SEA\\web\\PDF/cotizacion_N_" + cotizacion.getNumeroCotizacion() + ".pdf")));
...
//2nd paso)compose message
				try {
					...
					BodyPart adjunto = new MimeBodyPart();
					adjunto.setDataHandler(new DataHandler(new FileDataSource("C:\\Users\\Administrator\\Documents\\NetBeansProjects\\SEA\\web\\EXCEL/cotizacion_N_" + cotizacion.getNumeroCotizacion() + ".xlsx")));
